"""
    ./py/post_process_open_boundary_condition.py
...
def multi_ids_plot():
    ...
    fig = plt.figure(figsize=(prl_figure_width, prl_figure_width /
                     golden_ratio), dpi=300, layout='constrained')
    ...
    s = 2.6
    fig = plt.figure(figsize=(1.1*prl_figure_width/s,
                     prl_figure_width/s), dpi=300, layout='constrained')
