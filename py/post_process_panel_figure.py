"""
    ./py/post_process_panel_figure.py

    Author: Fabian R. Lux
    Date:   2023-03-22

    Composes Fig 2. of the manuscript
"""
...
fig, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(
    aspect*prl_figure_width, prl_figure_width))
...
files = ['../data/5_4_modulo_2.eig', '../data/5_4_modulo_3.eig', '../data/5_4_modulo_4.eig',
         '../data/5_4_modulo_5.eig', '../data/5_4_modulo_6.eig', '../data/5_4_modulo_7.eig', '../data/5_4_modulo_8.eig']
mods = [2, 3, 4, 5, 6, 7, 8]

sys_size = [160, 360, 2560, 15000, 57600, 58800, 81920]

files_subset = ['../data/5_4_modulo_2.eig',
                '../data/5_4_modulo_4.eig', '../data/5_4_modulo_8.eig']
mod_subset = [2, 4, 8]
labels_subset = [r"$2,1,160=s,k, |G_k|$", r"$2,2,2560$",  r"$2,3,81920$"]

labels = [r"$2,1,160=s,k, |G_k|$", r"$3,1,360$", r"$2,2,2560$",
          r"$5,1,15000$", r"$6,1,57600$", r"$7,1,58800$", r"$2,3,81920$"]
...
def plot(pn_tuple):
    ...
    # -- plot
    ax3.plot(np.linspace(0, 1, len(spec)), spec, 'o', markersize=1,
             label=r"${},{},{}$".format(p, n, int(len(spec)/4)))
...
ax3.fill_between(np.linspace(0, 1, 20),
                 gap_2[0]*id, gap_2[1]*id, color='lightgray')
